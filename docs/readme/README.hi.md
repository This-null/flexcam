...
- **रिमोट मोड (प्रयोगात्मक)** — मोबाइल डेटा सहित कहीं से भी फ़ोन इस्तेमाल करें;
  पोर्ट फ़ॉरवर्डिंग और खाता नहीं चाहिए
- **10 भाषाएँ**, 6 थीम, डार्क UI, ट्रे सपोर्ट
- USB और WiFi **पूरी तरह आपके डिवाइस पर** चलते हैं
...
3. USB से **स्वतः कनेक्ट** होता है। WiFi के लिए फ़ोन का IP और ऐप में दिखाया गया
   **एक्सेस कोड** लिखें।
4. अपने वीडियो ऐप में कैमरा **"FlexCam"** चुनें (या OBS इस्तेमाल करते हों तो
   **"OBS Virtual Camera"**)।

> USB के लिए **USB डिबगिंग** चालू होना चाहिए (डेवलपर विकल्प)। WiFi को केबल की
> ज़रूरत नहीं।

## रिमोट कनेक्शन (प्रयोगात्मक)

रिमोट मोड से फ़ोन **किसी भी नेटवर्क** से आपके PC तक पहुँच सकता है — दूसरा WiFi,
दोस्त का घर, या मोबाइल डेटा। कुछ भी सेट करने की ज़रूरत नहीं: न पोर्ट फ़ॉरवर्डिंग,
न राउटर सेटिंग, न कोई खाता।

1. PC पर **रिमोट कनेक्शन** खोलें और क्वालिटी चुनें।
2. FlexCam एक अस्थायी टनल खोलकर **QR कोड** दिखाता है।
3. फ़ोन पर **रिमोट से जुड़ें → QR कोड स्कैन करें** दबाएँ।

**जो आपको पता होना चाहिए:**

- वीडियो **Cloudflare** से होकर जाता है, जहाँ TLS समाप्त होता है, इसलिए तकनीकी
  रूप से वे उसे देख सकते हैं। USB और WiFi में ऐसा नहीं होता।
- Cloudflare के अनुसार Quick Tunnels परीक्षण और विकास के लिए हैं, किसी अपटाइम की
  गारंटी नहीं — इसीलिए यह सुविधा प्रयोगात्मक है।
- लोकल नेटवर्क से **ज़्यादा लेटेंसी** और वास्तविक **डेटा खपत** होगी; हर क्वालिटी
  के साथ प्रति घंटा अनुमान दिखता है।
- हर सत्र में नया पता और नई 128-बिट कुंजी बनती है। कुंजी कभी भेजी नहीं जाती, और
  बार-बार गलत कोशिशों पर सुनना बंद हो जाता है।
- रिमोट मोड **डिफ़ॉल्ट रूप से बंद** रहता है।
...
USB और लोकल WiFi सब कुछ आपके अपने डिवाइस पर रखते हैं।

रिमोट मोड अपवाद है: यह जानबूझकर वीडियो को Cloudflare के नेटवर्क से भेजता है, क्योंकि
बिना पोर्ट खोले कनेक्शन इसी से संभव होता है। यह तभी चलता है जब आप इसे चालू करें।
